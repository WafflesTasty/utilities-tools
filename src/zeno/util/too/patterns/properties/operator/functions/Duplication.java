package zeno.util.too.patterns.properties.operator.functions;

import zeno.util.too.patterns.manipulators.Copyable;
import zeno.util.too.patterns.properties.operator.Operation;
